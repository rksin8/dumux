...
public:
     ...
     *       \f$-|\sigma| n^T \mathbf{K} \left( \nabla p - \rho \mathbf{g} \right)\f$,
     *       where \f$|\sigma|\f$ is the area of the face and \f$n\f$ is the outer
     *       normal vector. Thus, the flux is given in N*m, and can be converted
     *       into a velocity (m/s) or mass flux (kg/s) by applying an upwind scheme
